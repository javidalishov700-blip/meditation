...
Vitrin fallback: $3.99 / hafta, $12.99 / ay, $59.99 / yıl. Canlı fiyat App Store ülkesinden (dil değil). Native IPA: doğrudan Apple StoreKit 2 (`native/capacitor-storekit`, ürünler `app.steady.pro.weekly|monthly|yearly`) — 3. parti satın alma SDK'sı yok. Ücretsiz deneme yok. Tarayıcı: yerel vitrin demosu. Product ids: `store/app-store-products.json`.
